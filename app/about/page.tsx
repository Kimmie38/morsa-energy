      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <div className="overflow-hidden rounded-2xl shadow">
            <Image src="/images/Abt-image1.png" alt="Mining operations" width={900} height={580} className="w-full h-[35rem] object-cover rounded-2xl" />
          </div>
        </section>
      </main>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="overflow-hidden rounded-2xl">
              <Image src="/images/Abt-image.png" alt="Engineering" width={700} height={480} className="w-full h-[35rem] object-cover rounded-2xl" />
            </div>
            <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-6">
              <div className="overflow-hidden rounded-3xl shadow-lg">
                <img src="/images/gal1.png" alt="CSR 1" className="w-full h-[35rem] object-cover" />
              </div>
              <div className="overflow-hidden rounded-3xl shadow-lg">
                <img src="/images/gal4.png" alt="CSR 4" className="w-full h-[35rem] object-cover" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="overflow-hidden rounded-3xl shadow-lg">
                <img src="/images/gal2.png" alt="CSR 2" className="w-full h-[35rem] object-cover" />
              </div>
              <div className="overflow-hidden rounded-3xl shadow-lg">
                <img src="/images/gal5.png" alt="CSR 5" className="w-full h-[35rem] object-cover" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="overflow-hidden rounded-3xl shadow-lg">
                <img src="/images/gal3.png" alt="CSR 3" className="w-full h-[35rem] object-cover" />
              </div>
              <div className="overflow-hidden rounded-3xl shadow-lg">
                <img src="/images/gal6.png" alt="CSR 6" className="w-full h-[35rem] object-cover" />
              </div>
            </div>
          </div>
        </div>
